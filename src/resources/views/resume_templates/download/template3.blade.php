                ...
                <div class="media flex-column flex-md-row">
                    <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
                        <div class="primary-info">
                            <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">{{$first_name}} {{$last_name}}</h1>
            ...
            <div class="resume-body p-5">
                ...
                <div class="row">
                    <div class="col-lg-9">
                                            ...
                                            <article class="resume-timeline-item position-relative pb-5">
                                                ...
                                                <div class="resume-timeline-item-header mb-2">
                                                    <div class="d-flex flex-column flex-md-row">
                                                        <h3 class="resume-position-title font-weight-bold mb-1">{{$experience[$i][0]}}</h3>
                                                        <div class="resume-company-name ml-auto">{{$experience[$i][2]}}</div>
                                                    </div>
                                                    <div class="resume-position-time">{{$experience[$i][3]}}</div>
                                                </div>
                        ...
                        <section class="resume-section experience-section mb-5">
                            <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Проекты</h2>
                            <div class="resume-section-content">
                                <div class="resume-timeline position-relative">
                                    @for($i=0;$i<2;$i++)
                                        @if($project[$i]['name'])
                                            <article class="resume-timeline-item position-relative pb-5">
                                                ...
                                                <div class="resume-timeline-item-header mb-2">
                                                    <div class="d-flex flex-column flex-md-row">
                                                        <h3 class="resume-position-title font-weight-bold mb-1">{{$project[$i]['name']}}</h3>
                                ...
                                <div class="resume-skill-item">
                                    <ul class="list-unstyled mb-4">
                                        @for($i=0;$i<3;$i++)
                                            @if($skills[$i])
                                                <li class="mb-2">
                                                    <div class="resume-skill-name">{{$skills[$i]}}</div>
