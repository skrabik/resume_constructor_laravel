 <head>
    ...
    <div class="work-experience">
        ...
        @for($i=0;$i<3;$i++)
            @if($experience  [$i][0])
                <div class="job-box">
                    <div class="job-title">{{$experience[$i][0]}}</div>
                    <div class="job-date">{{$experience[$i][2]}}</div>
                    <div class="job-description">{{$experience[$i][1]}}</div>
                </div>
            @endif
        @endfor
    ...
    <div class="education">
        <div class="work-img"> <img src="https://papik.pro/grafic/uploads/posts/2023-04/1681608872_papik-pro-p-navigatori-detstva-logotip-na-prozrachnom-17.png">
        </div>
        <h1>Projects</h1>
        @for($i=0;$i<2;$i++)
            @if($project[$i]['name'])
                <div class="job-box">
                    <div class="job-title">{{$project[$i]['name']}}</div>
                    <div class="job-description">{{$project[$i]['description']}}</div>
                </div>
            @endif
        @endfor
